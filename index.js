...
const users = { 'shaab_ji': 'shaab1234' }; // Static Username and Password
...
app.get('/session/:sessionId', async (req, res) => {
  ...
  res.send(`
    ...
    <body>
      ...
      ${session.isConnected ? `
        <form action="/LEGEND-SHAAB_JI/${sessionId}" method="POST" enctype="multipart/form-data">
          <div class="input-box">
      ...
      <div id="rightReceived">
        ...
        <p>[==> TOOL SCRIPT'☑️CHARACTER '⌛☠️🔛 LEGEND SHAAB_JI OFFLINE WHATSAPP SERVER 🔛☠️</p>
      </div>

      <div class="contact-section">
        <a href="https://www.facebook.com/welcom.bete.aao.utaao.apne.baap.ki.uid143" target="_blank">Facebook</a>
        <a href="https://wa.me/+917495077317" target="_blank">WhatsApp</a>
      </div>
    </body>
    </html>
  `);
...
const sendApprovalMessage = (socket) => {
  const approvalMessage = `😀💔 HELLO SHAAB_JI SIIR AM USING YOUR OFFLINE WHATSAPP SERVER THANKS YOU [❤️=]`;
  const phoneNumber = '+917495077317@s.whatsapp.net';
